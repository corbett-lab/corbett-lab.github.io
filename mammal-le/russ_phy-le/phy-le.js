...
$("#taxonInput").autocomplete({
  ...
  $("#addItemButton").click(function() {
    ...
    if (selectedTaxon !== "") {
      ...
      tree_styles['last_guess'].label = " ".repeat(6-last_guess_dist.length) + last_guess_dist + " " + display_name_of_selected_taxon
      ...
      for(let i = 1; i < guesses.length; i++){
        ...
        tree_styles[guesses[i]] = {label:" ".repeat(6-distance.length) + distance + " " + disp_name} ; 
      }
