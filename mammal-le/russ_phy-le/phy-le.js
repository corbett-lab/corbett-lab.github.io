...
async function main() {
  ...
  else if ( selectedTree == "vertebrates" ) {
    display_names = verts_display_names;
    newickTree = verts_newickTree;
    leaf_names = verts_leaf_names;
  } 
  else if ( selectedTree == "supermammal") {
    display_names = supermammal_display_names;
    newickTree = supermammal_newickTree;
    leaf_names = supermammal_leaf_names;
  }
...
$("#taxonInput").autocomplete({
  ...
  $("#addItemButton").click(function() {
    ...
    console.log("Registered button hit") ;
    ...
    if (display_name_of_selected_taxon == "") {
      ...
      //pick five at random
      var possibleHints = getRandomValuesFromArray(leaf_names);
      console.log('Guessed');
